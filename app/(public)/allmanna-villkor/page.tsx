...
export const metadata: Metadata = {
  ...
  description: 'Allmänna villkor för Gridex elavtal, teckning, avtal, fullmakt, ångerrätt, fakturering och leverantörsbyte.',
...
const sections = [
  ['1. Parter', 'Dessa villkor gäller mellan Gridex AB, org.nr 559416-7149, och dig som tecknar eller ingår elhandelsavtal med Gridex som privatperson eller företag.'],
  ['2. Teckning och avtal', 'När du skickar in en teckning behandlar Gridex dina uppgifter och kontrollerar att valt avtal, prisuppgifter, kunduppgifter och anläggningsuppgifter är tillräckliga. Avtalsstart sker först när uppgifterna är verifierade och Gridex har bekräftat nästa steg.'],
  ['3. Pris och avgifter', 'Elhandelspriset kan bestå av elpris, påslag, månadsavgift, fakturaavgift, skatter, moms och andra avgifter som visas innan du tecknar. Elnätsavgiften faktureras normalt av elnätsföretaget och ingår inte i Gridex elhandelspris.'],
  ...
  ['7. Gridex ansvar', 'Gridex ansvarar för att behandla teckning, administrera avtalet, hantera kommunikation och informera om viktiga steg. Om uppgifter saknas kan avtalsstart pausas tills uppgifterna är kompletterade.'],
  ['8. Ångerrätt för konsument', 'Konsumenter har normalt 14 dagars ångerrätt vid distansavtal. Information om ångerrätt lämnas separat innan du tecknar och finns på sidan Ångerrätt.'],
    ...
    <div className="mx-auto max-w-4xl px-6 py-14 md:py-18">
      <div className="rounded-3xl border border-white/10 bg-[#0B0F17] p-8 md:p-10">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-gray-300 md:text-base">
          Villkoren beskriver hur teckning, avtal, pris, fullmakt, ångerrätt och fakturering fungerar hos Gridex.
        </p>
      </div>
