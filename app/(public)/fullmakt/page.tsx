...
export const metadata: Metadata = {
  ...
  description:
    'Fullmakt som gör att Gridex kan begära och hantera anläggningsuppgifter från elnätsföretaget för att behandla en ansökan om elavtal.',
    ...
    <div className="mx-auto max-w-4xl px-6 py-14 md:py-18">
      ...
      <div className="mt-8 space-y-6">
        ...
        <Info
          ...
          text="Fullmakten omfattar uppgifter som anläggnings-ID, mätpunkts-ID, nätområde, nätägare, adresskoppling, mätarrelaterade uppgifter och annan information som behövs för att behandla ansökan och administrera elavtalet."
        />
        <Info
          title="Hur används uppgifterna?"
          text="Uppgifterna används för att kontrollera att ansökan gäller rätt anläggning, skapa korrekt kund- och avtalsunderlag, hantera leverantörsbyte och administrera avtalet. Uppgifterna används inte för andra ändamål än vad som behövs för elavtalet och tillhörande administration."
        />
        <Info
          title="Hur länge gäller fullmakten?"
          text="Fullmakten gäller så länge den behövs för att behandla ansökan, starta avtalet och administrera elavtalet. Den sparas tillsammans med ansökan och kan användas som underlag om nätägaren eller Gridex behöver verifiera behörigheten."
        />
      </div>
