...
import { fetchOpsPublicContracts, type OpsWebsitePriceArea } from '@/lib/ops/client'
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const validated = validateWebsitePricingQuote({
      token,
      contract,
      priceAreaCode,
      estimatedMonthlyKwh,
    ...
    return NextResponse.json({ ok: true, expires_at: validated.quote.expires_at })
  } catch {
