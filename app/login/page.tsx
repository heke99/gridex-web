...
export default async function LoginPage({ searchParams }: Props) {
  ...
  const banner =
    reason === 'forbidden'
      ? 'Du saknar behörighet för denna del av plattformen.'
      : ''
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-xl">
            ...
            <form action={loginWithPassword} className="mt-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="h-11 w-full rounded-xl border border-white/10 bg-black/40 px-3 text-sm text-white outline-none placeholder:text-white/30 focus:border-cyan-400 transition"
              ...
              <button
                type="submit"
                className="h-11 w-full rounded-xl bg-white text-sm font-semibold text-black hover:bg-white/90 transition"
              >
                Logga in
              </button>
            </form>
            ...
            <div className="mt-6 border-t border-white/10 pt-4">
              ...
              <button
                type="button"
                disabled
                className="w-full h-11 rounded-xl border border-white/10 bg-black/30 text-sm text-white/50 cursor-not-allowed"
              >
