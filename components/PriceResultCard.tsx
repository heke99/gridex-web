    ...
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0B0F17] p-6 transition hover:border-cyan-400/40 md:p-8">
      ...
      <div className="relative space-y-6">
        ...
        <div className="space-y-3 rounded-2xl border border-white/10 bg-black/20 p-5 text-sm">
          ...
          {hasNumber(fees.invoiceFeeSek) ? <div className="flex justify-between gap-4"><span className="text-gray-300">Fakturaavgift</span><span className="text-right text-gray-100">{formatNumber(fees.invoiceFeeSek, 2)} kr/faktura{invoiceIncluded === true ? ' • inräknad i uppskattningen' : invoiceIncluded === false ? ' • per faktura' : ' • enligt avtalsvillkor'}</span></div> : null}
