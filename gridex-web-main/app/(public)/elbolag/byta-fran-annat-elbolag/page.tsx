...
const page = findPageByPath(marketPages, '/elbolag/byta-fran-annat-elbolag')

export const metadata: Metadata = {
  title: page?.title ?? 'Gridex',
  description: page?.description ?? 'Information från Gridex.',
  alternates: { canonical: `${SITE_URL}/elbolag/byta-fran-annat-elbolag` },
  robots: { index: true, follow: true },
  openGraph: page
    ? {
        title: page.title,
        description: page.description,
        url: `${SITE_URL}/elbolag/byta-fran-annat-elbolag`,
        siteName: 'Gridex AB',
        locale: 'sv_SE',
        type: 'website',
      }
