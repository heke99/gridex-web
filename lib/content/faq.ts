...
export const faqItems: FaqItem[] = [
  ...
  { id: 'avtalsskillnad', category: 'pris-och-avtal', checkoutRelevant: true, question: 'Vad är skillnaden mellan fast pris, månadspris, timpris, kvartspris och portföljpris?', answer: 'Fast pris låser avtalets kWh-pris under den angivna perioden. Månadspris följer den publicerade månadsmodellen. Tim- och kvartspris prissätter användningen enligt respektive marknadsintervall. Portföljpris följer den avtalade portföljmodellen och dess låsta avgifter och andelar. De exakta avtalskomponenterna visas innan du tecknar.' },
  ...
  { id: 'saknade-uppgifter', category: 'byte-och-start', question: 'Vad händer om uppgifter saknas efter att jag tecknat?', answer: 'Vi markerar vad som saknas och pausar nästa steg vid behov. Gridex kontaktar dig för komplettering innan leverantörsbytet skickas vidare.' },
  ...
  { id: 'angerratt', category: 'juridik', question: 'Hur fungerar 14 dagars ångerrätt?', answer: 'Som konsument har du normalt 14 dagars ångerrätt vid distansavtal. Din bekräftelse visar signeringstid och ångerfrist när uppgifterna har fastställts.' },
  ...
  { id: 'mail', category: 'efter-teckning', checkoutRelevant: true, question: 'Vilka mail får jag efter teckningen?', answer: 'Du kan få mottagningsbekräftelse, avtalsbekräftelse och information om ångerrätten. Om du är ny kund skickas även ett separat mail för att aktivera Mina sidor. Kvittosidan visar vad som har initierats.' },
  ...
  { id: 'rattelse', category: 'efter-teckning', question: 'Hur kompletterar eller rättar jag uppgifter?', answer: 'Logga in på Mina sidor eller kontakta kundservice. Ändringar som påverkar identitet, avtal eller leverantörsbyte kan behöva verifieras innan de behandlas vidare.' },
]
