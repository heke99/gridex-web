...
assert.match(endpoint, /buildPublicContractsPayload/)
assert.match(publicContractsPayload, /blocked_contracts: browserBlockedContracts\(feed\)/)
assert.match(publicContractsPayload, /state: feed\.state/)
assert.match(publicContractsPayload, /compatibility_issue_count/)
