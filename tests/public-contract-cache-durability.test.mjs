...
const sharedSchema = read('supabase/migrations/20260803100040_public_contract_snapshot_shared_schema.sql')
...
assert.match(sharedSchema, /contract_publication_revisions/)
...
const sharedRpc = read('supabase/migrations/20260803100130_public_contract_snapshot_shared_rpc.sql')
assert.match(sharedRpc, /coalesce\(p_snapshot -> 'empty_feed_authorization', 'null'::jsonb\)/)
assert.match(sharedRpc, /p_publication_revision <> v_canonical_revision/)
assert.match(sharedRpc, /rejected_ahead_of_publication_state/)
assert.match(sharedRpc, /contract_publication_revisions/)
