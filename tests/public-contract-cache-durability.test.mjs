...
assert.match(migration, /v_publication_revision is not null/)
assert.match(migration, /v_publication_revision = p_publication_revision/)
assert.doesNotMatch(migration, /publication_reason/)
assert.doesNotMatch(migration, /all_contracts_unpublished/)
assert.doesNotMatch(migration, /v_normalized_reason/)
