...
assert.ok(calculator.includes('quote_reference: preview.quote_reference'))
assert.ok(form.includes('name="quote_reference"'))
assert.ok(form.includes('name="annual_consumption_kwh"'))
assert.ok(signup.includes('quoteReference'))
