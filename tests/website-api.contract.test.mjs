...
assert.ok(contract.includes("GRIDEX_WEBSITE_API_CONTRACT_VERSION = '2026-07-27.1'"))
...
assert.equal(websiteOpenApi.info.version, '2026-07-27.1')
...
assert.equal(customerPortalOpenApi.info.version, '2026-07-27.1')
...
console.log('Website API contract tests passed (2026-07-27.1)')
