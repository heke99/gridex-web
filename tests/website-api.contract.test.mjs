...
assert.ok(energyToken.includes("const TOKEN_VERSION = 'ea6'"))
assert.ok(energyToken.includes('version: 3'))
assert.ok(energyToken.includes('price_area_assurance'))
assert.ok(energyToken.includes('resolution_status'))
