...
assert.ok(quoteValidation.includes('validateWebsitePricingQuote'))
...
assert.ok(read('app/api/v1/website/energy/resolve/route.ts').includes('browserResolution'))
...
assert.ok(readiness.includes("'webhook_not_configured'"))
